...
newman()
{
	 ...
	 */
#ifndef LINT
	u.uhpmax = ((u.uhpmax - 10) * (int32_t)u.ulevel / oldlvl + 10) +
		(9 - rn2(19));
#endif
	...
	u.uhp = u.uhp + tmp;
#else
	u.uhp = u.uhp * (int32_t)u.uhpmax/tmp;
#endif

	tmp = u.uenmax;
#ifndef LINT
	u.uenmax = u.uenmax * (int32_t)u.ulevel / oldlvl + 9 - rn2(19);
#endif
	if (u.uenmax < 0) u.uenmax = 0;
#ifndef LINT
	u.uen = (tmp ? u.uen * (int32_t)u.uenmax / tmp : u.uenmax);
#endif
